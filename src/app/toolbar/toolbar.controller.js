(function ()
{
    ...
    /** @ngInject */
    function ToolbarController(storageService,$rootScope, $q, $state, $timeout, $mdSidenav, $translate, $mdToast, msNavigationService)
    {
        var vm = this;
        vm.user=storageService.model;
        // Data
        $rootScope.$on("userStatusEvent", function(event,args){
           vm.setUserStatus(args.status);
        });
        ...
        function init()
        {
            ...
            vm.userStatus = vm.userStatusOptions[4];
        ...
        {
            vm.userStatus = vm.userStatusOptions[status];
        }
